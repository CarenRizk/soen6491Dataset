...
public class SpannerIO {
  ...
  public abstract static class ReadAll
    ...
    public ReadAll withConfig(String projectId, String instanceId, String databaseId, String host, String emulatorHost) {
      SpannerConfig config = getSpannerConfig();
      return withSpannerConfig(config.withProjectId(ValueProvider.StaticValueProvider.of(projectId))
                                      .withInstanceId(ValueProvider.StaticValueProvider.of(instanceId))
                                      .withDatabaseId(ValueProvider.StaticValueProvider.of(databaseId))
  ...
  public abstract static class Read extends PTransform<PBegin, PCollection<Struct>> {
    ...
    // Optimized by LLM: Consolidated similar methods into one
    public Read withConfig(String projectId, String instanceId, String databaseId, String host, String emulatorHost) {
      SpannerConfig config = getSpannerConfig();
      return withSpannerConfig(config.withProjectId(ValueProvider.StaticValueProvider.of(projectId))
                                      .withInstanceId(ValueProvider.StaticValueProvider.of(instanceId))
                                      .withDatabaseId(ValueProvider.StaticValueProvider.of(databaseId))
  ...
  public abstract static class CreateTransaction
    ...
    // Optimized by LLM: Consolidated similar methods into one
    public CreateTransaction withConfig(String projectId, String instanceId, String databaseId, String host, String emulatorHost) {
      SpannerConfig config = getSpannerConfig();
      return withSpannerConfig(config.withProjectId(ValueProvider.StaticValueProvider.of(projectId))
                                      .withInstanceId(ValueProvider.StaticValueProvider.of(instanceId))
                                      .withDatabaseId(ValueProvider.StaticValueProvider.of(databaseId))
  ...
  public abstract static class Write extends PTransform<PCollection<Mutation>, SpannerWriteResult> {
    ...
    // Optimized by LLM: Consolidated similar methods into one
    public Write withConfig(String projectId, String instanceId, String databaseId, String host, String emulatorHost) {
      SpannerConfig config = getSpannerConfig();
      return withSpannerConfig(config.withProjectId(ValueProvider.StaticValueProvider.of(projectId))
                                      .withInstanceId(ValueProvider.StaticValueProvider.of(instanceId))
                                      .withDatabaseId(ValueProvider.StaticValueProvider.of(databaseId))
  ...
  public abstract static class ReadChangeStream
    ...
    // Optimized by LLM: Consolidated similar methods into one
    public ReadChangeStream withConfig(String projectId, String instanceId, String databaseId, String changeStreamName, String metadataInstance, String metadataDatabase, String metadataTable) {
      SpannerConfig config = getSpannerConfig();
      return withSpannerConfig(config.withProjectId(ValueProvider.StaticValueProvider.of(projectId))
                                      .withInstanceId(ValueProvider.StaticValueProvider.of(instanceId))
                                      .withDatabaseId(ValueProvider.StaticValueProvider.of(databaseId))
