...
public class TextIO {
  ...
  public abstract static class Read extends PTransform<PBegin, PCollection<String>> {
    ...
    abstract Optional<ValueProvider<String>> getFilepattern();
  ...
  public abstract static class TypedWrite<UserT, DestinationT>
    ...
    abstract static class Builder<UserT, DestinationT> {
      ...
      abstract Builder<UserT, DestinationT> setHeader(Optional<String> header);

      abstract Builder<UserT, DestinationT> setFooter(Optional<String> footer);
      ...
      abstract Builder<UserT, DestinationT> setDynamicDestinations(
          Optional<DynamicDestinations<UserT, DestinationT, String>> dynamicDestinations);
    ...
    public TypedWrite<UserT, DestinationT> withHeader(Optional<String> header) {
      return toBuilder().setHeader(header).build();
    }

    
    public TypedWrite<UserT, DestinationT> withFooter(Optional<String> footer) {
  ...
  public static class Write extends PTransform<PCollection<String>, PDone> {
    ...
    public Write withHeader(Optional<String> header) {
      return new Write(inner.withHeader(header));
    }

    
    public Write withFooter(Optional<String> footer) {
