...
public class SchemaTest {
  ...
  public void testCreate() {
    ...
    validateField(schema, "f_byte", 0, FieldType.BYTE); // Optimized by LLM: Extracted repeated assertions into a helper method
    validateField(schema, "f_int16", 1, FieldType.INT16); // Optimized by LLM: Extracted repeated assertions into a helper method
    validateField(schema, "f_int32", 2, FieldType.INT32); // Optimized by LLM: Extracted repeated assertions into a helper method
    validateField(schema, "f_int64", 3, FieldType.INT64); // Optimized by LLM: Extracted repeated assertions into a helper method
    validateField(schema, "f_decimal", 4, FieldType.DECIMAL); // Optimized by LLM: Extracted repeated assertions into a helper method
    validateField(schema, "f_float", 5, FieldType.FLOAT); // Optimized by LLM: Extracted repeated assertions into a helper method
    validateField(schema, "f_double", 6, FieldType.DOUBLE); // Optimized by LLM: Extracted repeated assertions into a helper method
    validateField(schema, "f_string", 7, FieldType.STRING); // Optimized by LLM: Extracted repeated assertions into a helper method
    validateField(schema, "f_datetime", 8, FieldType.DATETIME); // Optimized by LLM: Extracted repeated assertions into a helper method
    validateField(schema, "f_boolean", 9, FieldType.BOOLEAN); // Optimized by LLM: Extracted repeated assertions into a helper method
  }

  private void validateField(Schema schema, String fieldName, int index, FieldType fieldType) { // Optimized by LLM: Extracted repeated assertions into a helper method
