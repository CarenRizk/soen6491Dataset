...
final class AutoValue_Schema_Field extends Schema.Field {
  ...
  public Schema.Field.Builder toBuilder() {
    return new AutoValue_Schema_Field.Builder(this);
  }

  static final class Builder extends Schema.Field.Builder {
    private @Nullable String name;
    private @Nullable String description;
    private Schema.@Nullable FieldType type;
    private Schema.@Nullable Options options;
    Builder() {
    }
    Builder(Schema.Field source) {
