...
final class AutoValue_Schema_FieldType extends Schema.FieldType {
  ...
  public Schema.FieldType.Builder toBuilder() {
    return new AutoValue_Schema_FieldType.Builder(this);
  }

  static final class Builder extends Schema.FieldType.Builder {
    private Schema.@Nullable TypeName typeName;
    ...
    private @Nullable Map<String, Schema.ByteArrayWrapper> metadata;
    Builder() {
    }
    Builder(Schema.FieldType source) {
