...
public class PipelineTest {
  ...
  // Optimized by LLM: Consolidated exception handling classes
  static class TestPipelineRunnerThrowingException extends PipelineRunner<PipelineResult> {
    private final String message;

    public TestPipelineRunnerThrowingException(String message) {
      this.message = message;
    }

    public static TestPipelineRunnerThrowingException fromOptions(PipelineOptions options, String message) {
      return new TestPipelineRunnerThrowingException(message);
    }
  ...
  public void testPipelineUserExceptionHandling() {
    ...
    options.setRunner(TestPipelineRunnerThrowingException.fromOptions(options, "user code exception"));
  ...
  public void testPipelineSDKExceptionHandling() {
    PipelineOptions options = TestPipeline.testingPipelineOptions();
    options.setRunner(TestPipelineRunnerThrowingException.fromOptions(options, "SDK exception"));
    Pipeline p = Pipeline.create(options);
  ...
  // Optimized by LLM: Moved IdentityTransform to its own file
  ...
  // Optimized by LLM: Moved TupleProjectionTransform to its own file
  ...
  // Optimized by LLM: Moved TupleInjectionTransform to its own file
