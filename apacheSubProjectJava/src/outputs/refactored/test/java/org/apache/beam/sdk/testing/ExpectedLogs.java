...
public class ExpectedLogs extends ExternalResource {
  ...
  // Optimized by LLM: Consolidated verify methods into a single method
  ...
  // Optimized by LLM: Removed duplicate verify methods
  ...
  private final Level previousLevel; // Optimized by LLM: Made final
  ...
  public static class LogSaver extends Handler {
    ...
    // Optimized by LLM: Changed to public to allow external access
    public Collection<LogRecord> getLogs() {
      return Collections.unmodifiableCollection(logRecords); // Optimized by LLM: Prevent external modification
    }
