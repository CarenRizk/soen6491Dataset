...
import org.apache.beam.sdk.io.mongodb.FindQuery; // Check if this import is correct
import org.apache.beam.sdk.io.mongodb.UpdateConfiguration; // Check if this import is correct
import org.apache.beam.sdk.io.mongodb.UpdateField; // Check if this import is correct
import com.google.auto.value.AutoValue;
  ...
  static class BoundedMongoDbSource extends BoundedSource<Document> {
    ...
    public List<BoundedSource<Document>> split(
      ...
      try (MongoClient mongoClient =
        ...
        if (spec.queryFn().getClass() == FindQuery.class) {
          if (spec.bucketAuto()) {
