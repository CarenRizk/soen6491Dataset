...
public class ApproximateQuantilesTest {
  ...
  public static class CombinerTests {
    ...
    // Optimized by LLM: Extracted input table creation to a separate method
    private List<KV<String, Integer>> createInputTableData() {
      return TABLE;
    }

    public PCollection<KV<String, Integer>> createInputTable(Pipeline p) {
      return p.apply(
          Create.of(createInputTableData()).withCoder(KvCoder.of(StringUtf8Coder.of(), BigEndianIntegerCoder.of())));
    }
