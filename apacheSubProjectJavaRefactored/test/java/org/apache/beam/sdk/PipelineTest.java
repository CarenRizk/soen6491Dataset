...
import java.util.Optional; // Optimized by LLM: Removed unused imports
...
public class PipelineTest {
  ...
  private static class TupleProjectionTransform<T>
    ...
    private Optional<TupleTag<T>> tag; // Optimized by LLM: Used Optional for nullable fields
  ...
  private static class TupleInjectionTransform<T>
    ...
    public PCollectionTuple expand(PCollection<T> input) {
      return PCollectionTuple.of(tag.get(), input);
    }
  }
